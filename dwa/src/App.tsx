  ...
  return (
    <HelmetProvider>
      <Helmet>
        ...
        <meta property="og:title" content="Comitia" />
        ...
        <meta property="twitter:domain" content="https://comitia-dwa-production.up.railway.app" />
        <meta property="twitter:url" content="https://comitia-dwa-production.up.railway.app" />
        <meta name="twitter:title" content="Comitia" />
        <meta name="twitter:description" content="Bot that acts as a therapist. Users get to own their data. All the chats had with this bot and the medical info shared in the conversation are theirs." />
        <meta name="twitter:image" content="https://comitia-dwa-production.up.railway.app/app-preview.png" />

        {/* <!--  Non-Essential, But Recommended --> */}
        <meta name="twitter:image:alt" content="Comitia Help" />
